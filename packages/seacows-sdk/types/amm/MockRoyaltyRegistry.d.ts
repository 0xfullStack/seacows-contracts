...
interface MockRoyaltyRegistryInterface extends ethers.utils.Interface {
  functions: {
...
export class MockRoyaltyRegistry extends BaseContract {
  ...
  interface: MockRoyaltyRegistryInterface;
