...
library NFTRenderer {
    ...
    function renderBackground() internal pure returns (string memory background) {
        background = string.concat(
            ...
            '<linearGradient id="paint2_linear_4414_291095" x1="0" y1="0" x2="800" y2="1066" gradientUnits="userSpaceOnUse" > <stop stop-color="#509AFF" /> <stop offset="0.5" stop-color="#8440F3" /> <stop offset="1" stop-color="#BD61FF" /> </linearGradient>',
